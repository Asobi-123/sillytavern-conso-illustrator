export type AutoIllustratorErrorCode = 'api-request-failed' | 'llm-empty-response' | 'no-valid-prompts' | 'llm-unavailable' | 'main-response-empty' | 'prompt-insertion-failed' | 'image-command-unavailable' | 'image-advanced-backend-unavailable' | 'image-empty-response' | 'image-request-failed' | 'unknown';
